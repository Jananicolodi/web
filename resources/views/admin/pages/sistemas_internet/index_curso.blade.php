...
<body>
    <header>
        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h1 class=" font-italic">Tecnologia em Sistemas para Internet</h1>
                <p class="lead my-3">Breve descrição sobre o curso</p>
    ...
    <div class="row">
        <div class="col-md-3 mb-3">
            @include('admin.pages.sistemas_internet._partials.menu_lateral')
